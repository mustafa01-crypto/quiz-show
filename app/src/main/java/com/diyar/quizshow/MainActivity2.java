...
//ca-app-pub-6313549492070266/1659082945 banner ad

public class MainActivity2 extends AppCompatActivity {
    private AdView mAdView;
    Button answer1 , answer2 , answer3 , answer4 ,answer5;
    TextView score ,questions, timeText ;
    private  gyQustions mQuestions = new gyQustions();
    private String mAnswer ;
    private int mScore =0 ;
    private int gyQuestionsLength =mQuestions.mQuestions.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateQuestion(r.nextInt(gyQuestionsLength));
