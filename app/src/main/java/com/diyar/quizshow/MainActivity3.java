...
//ca-app-pub-6313549492070266/4393057491
public class MainActivity3 extends AppCompatActivity {
    //2018
    private AdView mAdView;
    Button answer1 , answer2 , answer3 , answer4 ,answer5;
    TextView score ,questions, timeText ;
    private  gkQuestions mQuestions = new gkQuestions();
    private String mAnswer ;
    private int mScore =0 ;
    private int gkQuestionsLength =mQuestions.mQuestions.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateQuestion(r.nextInt(gkQuestionsLength));
    ...
    public void gameOver() {
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MainActivity3.this);
        alertDialogBuilder
